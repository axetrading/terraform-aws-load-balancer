...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_target_group"></a> [target\_group](#module\_target\_group) | ./modules/target-groups | n/a |
...
| <a name="input_target_groups"></a> [target\_groups](#input\_target\_groups) | Target Group Configuration Block | `any` | `{}` | no |
